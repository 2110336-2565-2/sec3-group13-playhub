        ...
        <BorderWithShadow>
          <CardContent>
            <Stack spacing="12px" sx={{ padding: "20px" }}>
              <AppointmentHeader
                detailHeader={props.appointmentDetail.detailHeader}
                isHost={false}
              />
            </Stack>
          </CardContent>
          ...
          <CardContent>
            <Stack spacing="12px" sx={{ padding: "20px" }}>
              ...
              <Typography variant="h5" sx={{ fontWeight: "bold" }}>
                Number of Participant : {props.appointmentDetail.participantAmount}
              </Typography>
              <Box>
                <Typography variant="h5" sx={{ fontWeight: "bold", marginBottom: "4px" }}>
                  Participant List :
                ...
                <Grid container spacing={1}>
                  {props.appointmentDetail.acceptParticipants.map((e, index) => (
                    <Grid item key={"p" + index}>
                      ...
                      {index != 0 && (
                        <Chip label={e} variant="outlined" color="primary" style={chipsStyle} />
                      )}
                    </Grid>
                  ))}
                </Grid>
