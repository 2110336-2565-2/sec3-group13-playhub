...
export default function Advertise() {
  ...
  function onSubmit(): void {
    ...
    service.advertisement
      .CreateAdvertisement(owner, duration, fileImage)
      .then(() => {
  ...
  function handleOwnerTextFieldChange(
    ...
    <>
      ...
      <Stack margin={"30px auto auto auto"} width="60vw" minWidth="720px">
        ...
        <TextField
          ...
          error={errOwner.err}
        />
        <FormHelperText sx={{ margin: "10px" }} error>
          {errOwner.err && errOwner.msg}
          {"\u00A0"}
        </FormHelperText>
        <Typography variant="body1">Duration</Typography>
        <RadioGroup row defaultValue="female" onChange={handleDurationChange}>
          {STARTER_DURATION.map((amountOfDays) => {
            return (
              <FormControlLabel
                ...
                value={amountOfDays}
                control={<Radio />}
                label={amountOfDays.toString() + " day" + (amountOfDays === 1 ? "" : "s")}
        ...
        <FormHelperText error>
          {errDuration.err && errDuration.msg}
          {"\u00A0"}
        </FormHelperText>
        ...
        <Stack spacing={1}>
          <Card
            sx={{
              ...
              borderRadius: "15px",
              border: `3px ${
                errFileImage.err ? appTheme.palette.error.main : appTheme.palette.secondary.main
              }  solid`,
              aspectRatio: "970 / 250",
              display: "flex",
              alignItems: "center",
          ...
          >
            {displayImage ? (
              ...
              >
                ...
                <CameraAltIcon
                  color={errFileImage.err ? "error" : undefined}
                  sx={{ fontSize: "100px", opacity: errFileImage.err ? 0.5 : 1 }}
                />
              </IconButton>
            )}
          </Card>
          <FormHelperText error>
            {errFileImage.err && errFileImage.msg}
            {"\u00A0"}
          </FormHelperText>
        </Stack>
        <Stack
        ...
        >
          <CommonButton
            ...
            color={COLOR.NATURAL}
            onClick={() => {
              setShowDiscardDialog(!showDiscardDialog);
            }}
          />
